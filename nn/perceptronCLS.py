...
class Manboobs:
    ...
    def __init__(self, inputRepresentation):
        ...
        xTrain, yTrain, xTest, yTest = self.batchImport(self.inputRepresentation)
        self.xTrain = xTrain
        self.yTrain = yTrain
        self.xTest = xTest
        self.yTest = yTest
    ...
    def readBitmapsBatch(self, filename):
        ...
        for batchPair in self.grouper(file, 32 + 1):
            # create one giant string from the first 32 lines (strip the lines first)
    ...
    def batchImport(self, inputRepresentation):
        ...
        if inputRepresentation == "downsamples":
...
#manboob = Manboobs("downsamples")
manboob = Manboobs("bitmaps")
